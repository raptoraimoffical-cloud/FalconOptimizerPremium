$checks = @(
  'Section opens',
  'All 18 tabs load',
  'Power explorer cards render badge rows from item.badges',
  'Power explorer cards render support/doc/proof row',
  'Power explorer search includes title/id/description/badges/category',
  'Plan enumeration',
  ...
  'Category manifests are populated (not thin) for processor/storage/usb/wireless/sleep/energy-saver',
  'Firmware recommendations are named advisory cards (no numeric placeholders)',
  'Preset metadata classifies apply-safe/readback-only/advisory/hardware-conditional',
  'Report generation',
  'Snapshot restore',
