...
cd /d "%~dp0\..\.."
echo [Falcon] Running imported tweak: Nvidia_GPU_Tweaks
echo.
color A
chcp 65001 >nul 2>&1
setlocal
...
mkdir "%FalconLibrary_Backup_Folder%\GPU" >nul 2>&1
reg export "HKLM\SYSTEM\CurrentControlSet\Control\Class\{4d36e968-e325-11ce-bfc1-08002be10318}\%G%" "%FalconLibrary_Backup_Folder%\GPU\Nvidia.reg" /y >nul 2>&1
if errorlevel 1 (
) else ( 
)
"C:\FalconLibrary Tools\Nvidia\Nvidia Profile Inspector\nvidiaProfileInspector.exe" -importProfile "C:\FalconLibrary Tools\Nvidia\Nvidia Profile Inspector\NovaOS.nip" >nul 2>&1
if errorlevel 1 (
) else (
)
reg add "HKCR\DesktopBackground\Shell\NvidiaContainer" /v Icon /t REG_SZ /d "C:\FalconLibrary Tools\Nvidia\Nvidia Profile Inspector\nvidiaProfileInspector.exe,0" /f >nul 2>&1
...
reg add "HKCR\DesktopBackground\Shell\NvidiaContainer\Shell\EnableNvContainer\command" /ve /t REG_SZ /d "C:\FalconLibrary Tools\Nvidia\Nvidia Container\Nvidia Container ON.bat" /f >nul 2>&1
...
reg add "HKCR\DesktopBackground\Shell\NvidiaContainer\Shell\DisableNvContainer\command" /ve /t REG_SZ /d "C:\FalconLibrary Tools\Nvidia\Nvidia Container\Nvidia Container OFF.bat" /f >nul 2>&1
