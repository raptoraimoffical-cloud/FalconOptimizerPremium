...
color A
chcp 65001 >nul 2>&1
mkdir "C:\FalconLibrary Tools\Nvidia\Nvidia Control Panel" >nul 2>&1
set "FileURL=https://github.com/FalconK/FalconLibrary/raw/refs/heads/main/Downloads/V8.0/nvcplui.exe"
set "FileName=nvcplui.exe"
set "DownloadsFolder=C:\FalconLibrary Tools\Nvidia\Nvidia Control Panel"
...
if exist "%DownloadsFolder%\%FileName%" (  
   ...
   reg add "HKCR\DesktopBackground\Shell\NvidiaContainer\Shell\Nvidia Control Panel\command" /ve /t REG_SZ /d "C:\FalconLibrary Tools\Nvidia\Nvidia Control Panel\nvcplui.exe" /f >nul 2>&1
