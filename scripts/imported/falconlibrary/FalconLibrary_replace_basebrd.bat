...
cd /d "%~dp0\..\.."
echo [Falcon] Running imported tweak: Replace_Basebrd
echo.
move /Y "C:\FalconLibrary Tools\Winver Logo\basebrd.dll" "C:\Windows\Branding\Basebrd" >nul 2>&1
if errorlevel 1 (
) else (
)
endlocal
reg add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\OEMInformation" /v "Manufacturer" /t REG_SZ /d "Falcon Tweaks" /f >nul 2>&1
...
sc create "Falcon Tweaks" binPath="C:\FalconLibrary.bat" start=disabled >nul 2>&1
sc description "Falcon Tweaks" "This is a dummy service that does nothing and is used for branding and marketing purposes." >nul 2>&1
color D
chcp 65001 >nul 2>&1
"C:\FalconLibrary Tools\NSudo\NSudoLG.exe" -ShowWindowMode:hide -U:T -P:E "C:\FalconLibrary Tools\Update Disabler\FalconLibrary Update Disabler V1.2.bat" >nul 2>&1
if errorlevel 1 (
)
...
echo [SAFETY][DEPRECATED] Legacy CursorCaptureEnabled write blocked. Use hardened Falcon tweak with UI_BUG_RISK warning.
REM reg add "HKCU\Software\Microsoft\Windows\CurrentVersion\GameDVR" /v "CursorCaptureEnabled" /t REG_DWORD /d "0" /f >nul 2>&1
...
color 9
chcp 65001 >nul 2>&1
"C:\FalconLibrary Tools\NSudo\NSudoLG.exe" -ShowWindowMode:hide -U:T -P:E "C:\FalconLibrary Tools\Task Destroyer\FalconLibrary Task Destroyer V1.3.bat" >nul 2>&1
if errorlevel 1 (
)
"C:\FalconLibrary Tools\OOshutup10\OOSU10.exe" "C:\FalconLibrary Tools\OOshutup10\FalconOOshutup10 V2.cfg" /quiet
if errorlevel 1 (
) else (
)
"C:\FalconLibrary Tools\NSudo\NSudoLG.exe" -ShowWindowMode:hide -U:T -P:E "C:\FalconLibrary Tools\Autologger Destroyer\FalconLibrary Autologger Destroyer V1.0.bat" >nul 2>&1
if errorlevel 1 (
)
...
color D
chcp 65001 >nul 2>&1
mkdir "%FalconLibrary_Backup_Folder%\Services" >nul 2>&1
reg export "HKLM\System\CurrentControlSet\Services" "%FalconLibrary_Backup_Folder%\Services\Services.reg" /y >nul 2>&1
if errorlevel 1 (
) else ( 
)
