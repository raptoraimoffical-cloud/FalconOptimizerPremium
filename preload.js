...
removePowerPlans: () => ipcRenderer.invoke("falcon:removePowerPlans"),
  ...
  powerManagementApplyItem: (itemId) => ipcRenderer.invoke("falcon:powerManagementApplyItem", { itemId }),
  powerManagementVerify: () => ipcRenderer.invoke("falcon:powerManagementVerify"),
  powerManagementVerifyItem: (itemId) => ipcRenderer.invoke("falcon:powerManagementVerifyItem", { itemId }),
  powerManagementRollbackItem: (itemId) => ipcRenderer.invoke("falcon:powerManagementRollbackItem", { itemId }),
