...
if errorlevel 1 (
    echo [%DATE% %TIME%] Audio Bloat Remover: Realtek Bloat not found. >> "C:\FalconLibrary Logs\FalconLibrary Log.txt"
    echo ❌ Realtek Bloat not found.
    goto :Sound_Research_Check
) else ( 
    echo [%DATE% %TIME%] Audio Bloat Remover: Realtek Bloat found. >> "C:\FalconLibrary Logs\FalconLibrary Log.txt"
...
for /d %%G in ("%DriverStorePath%\%FilePattern%") do (
    echo [%DATE% %TIME%] Audio Bloat Remover: Realtek Driver Path: %%G >> "C:\FalconLibrary Logs\FalconLibrary Log.txt"
    rd /s /q "%%G" >nul 2>&1
)
...
if errorlevel 1 (
    echo [%DATE% %TIME%] Audio Bloat Remover: Sound Research Bloat not found. >> "C:\FalconLibrary Logs\FalconLibrary Log.txt"
    echo ❌ Sound Research Bloat not found.
    goto :VisiSonics_Check
) else ( 
    echo [%DATE% %TIME%] Audio Bloat Remover: Sound Research Bloat found. >> "C:\FalconLibrary Logs\FalconLibrary Log.txt"
...
if errorlevel 1 (
    echo [%DATE% %TIME%] Audio Bloat Remover: VisiSonics Bloat not found. >> "C:\FalconLibrary Logs\FalconLibrary Log.txt"
    echo ❌ VisiSonics Bloat not found.
    goto :End
) else ( 
    echo [%DATE% %TIME%] Audio Bloat Remover: VisiSonics Bloat found. >> "C:\FalconLibrary Logs\FalconLibrary Log.txt"
