...
if errorlevel 1 (
    echo [%DATE% %TIME%] Process Destroyer Services Reg Backup: Failed to create. >> "C:\FalconLibrary Logs\FalconLibrary Log.txt"
) else ( 
    echo [%DATE% %TIME%] Process Destroyer Services Reg Backup: Created successfully. >> "C:\FalconLibrary Logs\FalconLibrary Log.txt"
)
